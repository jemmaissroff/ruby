...
module RubyVM::MJIT # :nodoc: all
  ...
  def C.rb_shape
    @rb_shape ||= CType::Struct.new(
      ...
      edge_name: [self.ID, Primitive.cexpr!("OFFSETOF((*((struct rb_shape *)NULL)), as.shape_with_properties.edge_name)")],
      next_iv_index: [self.attr_index_t, Primitive.cexpr!("OFFSETOF((*((struct rb_shape *)NULL)), as.shape_with_properties.next_iv_index)")],
      capacity: [CType::Immediate.parse("uint32_t"), Primitive.cexpr!("OFFSETOF((*((struct rb_shape *)NULL)), as.shape_with_properties.capacity)")],
