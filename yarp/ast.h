...
typedef enum {
    YP_REGULAR_EXPRESSION_FLAGS_IGNORECASE = 1 << 0,
    YP_REGULAR_EXPRESSION_FLAGS_MULTILINE = 1 << 1,
    YP_REGULAR_EXPRESSION_FLAGS_EXTEND = 1 << 2,
    YP_REGULAR_EXPRESSION_FLAGS_EUCJP = 1 << 3,
    YP_REGULAR_EXPRESSION_FLAGS_ASCII8BIT = 1 << 4,
    YP_REGULAR_EXPRESSION_FLAGS_WINDOWS31J = 1 << 5,
