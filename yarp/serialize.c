...
yp_serialize_node(yp_parser_t *parser, yp_node_t *node, yp_buffer_t *buffer) {
    ...
    switch (node->type) {
        ...
        case YP_NODE_STRING_INTERPOLATED_NODE: {
            serialize_location(parser, &((yp_string_interpolated_node_t *)node)->opening_loc, buffer);
            ...
            serialize_location(parser, &((yp_string_interpolated_node_t *)node)->closing_loc, buffer);
            break;
        }
