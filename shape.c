...
shape_id_t
rb_shape_shape_id(rb_shape_t * shape)
{
...
{
    rb_shape_set_shape_id(obj, rb_shape_shape_id(shape));
}
...
rb_shape_id(VALUE self) {
    ...
    return INT2NUM(rb_shape_shape_id(shape));
}
...
rb_shape_parent_id(VALUE self)
{
    ...
    TypedData_Get_Struct(self, rb_shape_t, &shape_data_type, shape);
    if (shape->parent) {
        return INT2NUM(rb_shape_shape_id(shape->parent));
    }
    else {
        return Qnil;
    }
...
VALUE rb_obj_shape(rb_shape_t* shape) {
    ...
    rb_hash_aset(rb_shape, ID2SYM(rb_intern("id")), INT2NUM(rb_shape_shape_id(shape)));
    ...
    if (shape == rb_shape_get_root_shape()) {
        ...
        rb_hash_aset(rb_shape, ID2SYM(rb_intern("parent_id")), INT2NUM(rb_shape_shape_id(shape->parent)));
    }
